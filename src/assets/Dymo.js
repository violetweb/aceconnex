...
(function () {
    ...
    function w(a, b) {
      ...
      for (var g; d.length && (g = d.shift()); ) d.length || void 0 === b ? e[g] ? e = e[g] : e = e[g] = {
      }
       : e[g] = b
    }
    function x(a, b) {
    ...
    function Ga(a, b) {
      for (var d, e, g = 1; g < arguments.length; g++) {
        e = arguments[g];
        for (d in e) a[d] = e[d];
        for (var h = 0; h < Fa.length; h++) d = Fa[h],
    ...
    function ab(a, b, d) {
      if (!(a.nodeName in Za)) if (3 == a.nodeType) d ? b.push(String(a.nodeValue).replace(/(\r\n|\r|\n)/g, ''))  : b.push(a.nodeValue);
       ...
       else for (a = a.firstChild; a; ) ab(a, b, d),
      a = a.nextSibling
    };
    function bb(a) {
    ...
    var Vb = 'closure_listenable_' + (1000000 * Math.random() | 0),
    Wb = 0;
    ...
    var cc = 'closure_lm_' + (1000000 * Math.random() | 0),
    dc = {
    },
    ec = 0;
    ...
    function kc(a, b) {
      ...
      if (!Qb) {
        ...
        if (!(d = b)) a: {
          ...
          for (var e = p, g; g = d.shift(); ) if (null != e[g]) e = e[g];
           else {
            d = null;
            break a
          }
    ...
    var pc = '__closure_events_fn_' + (1000000000 * Math.random() >>> 0);
    function gc(a) {
      if (u(a)) return a;
    ...
    function K(a, b) {
      ...
      var k = !0,
      l;
      if (d) for (var m = d.length - 1; 0 <= m; m--) l = g.c = d[m],
      k = qc(l, h, !0, g) && k;
      l = g.c = e;
      k = qc(l, h, !0, g) && k;
      k = qc(l, h, !1, g) && k;
      if (d) for (m = 0; m < d.length; m++) l = g.c = d[m],
      k = qc(l, h, !1, g) && k
    }
    I.prototype.K = function () {
      ...
      if (this.D) {
        ...
        d;
        for (d in a.c) {
          for (var e = a.c[d], g = 0; g < e.length; g++) ++b,
          Yb(e[g]);
          delete a.c[d];
          a.f--
        }
    ...
    function yc(a) {
      ...
      if (da(a)) {
        for (var b = [
        ], d = a.length, e = 0; e < d; e++) b.push(a[e]);
        return b
      }
      return Da(a)
    }
    function zc(a, b) {
      if ('function' == typeof a.forEach) a.forEach(b, void 0);
        ...
        if ('function' == typeof a.I) d = a.I();
         else if ('function' != typeof a.J) if (da(a) || t(a)) {
          d = [
          ];
    ...
    n.J = function () {
      Cc(this);
      for (var a = [
      ], b = 0; b < this.c.length; b++) a.push(this.f[this.c[b]]);
      return a
    };
    n.I = function () {
      Cc(this);
    ...
    function Cc(a) {
      ...
      if (a.h != a.c.length) {
        for (var g = {
        }, d = b = 0; b < a.c.length; ) e = a.c[b],
        Dc(g, e) || (a.c[d++] = e, g[e] = 1),
        b++;
        a.c.length = d
      }
    }
    ...
    function Zc(a) {
      if ($c) {
        ...
        if (b) {
          var d = b.href;
          if (d && (d = (d = Zc(d) [3] || null) ? decodeURI(d)  : d) && d != b.hostname) throw $c = !0,
          Error();
        }
      }
      return a.match(Yc)
    ...
    n.send = function (a, b, d, e) {
      ...
      try {
        ld(this),
        0 < this.i && (this.B = md(this.c), L(this.v, M(this, 'Will abort after ' + this.i + 'ms if incomplete, xhr2 ' + this.B)), this.B ? (this.c.timeout = this.i, this.c.ontimeout = v(this.L, this))  : this.G = rc(this.L, this.i, this)),
        L(this.v, M(this, 'Sending request')),
        this.s = !0,
        this.c.send(a),
        this.s = !1
      } catch (k) {
        L(this.v, M(this, 'Send error: ' + k.message)),
        kd(this, k)
      }
    };
    function md(a) {
    ...
    function pd(a) {
      if (a.f && 'undefined' != typeof aa) if (a.H[1] && 4 == qd(a) && 2 == a.w()) L(a.v, M(a, 'Local request error detected and ignored'));
       else if (a.s && 4 == qd(a)) rc(a.ha, 0, a);
       else if (K(a, 'readystatechange'), 4 == qd(a)) {
        L(a.v, M(a, 'Request complete'));
        a.f = !1;
        try {
          if (rd(a)) K(a, 'complete'),
          K(a, 'success');
           else {
            var b;
            try {
              ...
              L(a.v, 'Can not get status: ' + d.message),
              b = ''
            }
            a.m = b + ' [' + a.w() + ']';
            od(a)
    ...
    function rd(a) {
      ...
      if (!d) {
        if (b = 0 === b) a = Zc(String(a.o)) [1] || null,
  ...
  function sd(a) {
    try {
      ...
      return L(a.v, 'Can not get response: ' + d.message),
      null
    }
  }
  function M(a, b) {
  ...
  N.prototype.toString = function () {
    ...
    if (b = this.f) this.c && '/' != b.charAt(0) && a.push('/'),
  ...
  function Gd(a, b) {
    ...
    var k = e.f;
    if (h) ud(g, e.s);
     else if (h = !!e.f) if ('/' != k.charAt(0) && (d.c && !d.f ? k = '/' + k : (d = g.f.lastIndexOf('/'), - 1 != d && (k = g.f.substr(0, d + 1) + k))), d = k, '..' == d || '.' == d) k = '';
     else if (A(d, './') || A(d, '/.')) {
      for (var k = 0 == d.lastIndexOf('/', 0), d = d.split('/'), l = [
      ], m = 0; m < d.length; ) {
        var r = d[m++];
        '.' == r ? k && m == d.length && l.push('')  : '..' == r ? ((1 < l.length || 1 == l.length && '' != l[0]) && l.pop(), k && m == d.length && l.push(''))  : (l.push(r), k = !0)
      }
      k = l.join('/')
    } else k = d;
  ...
  n.I = function () {
    Id(this);
    for (var a = this.c.J(), b = this.c.I(), d = [
    ], e = 0; e < b.length; e++) for (var g = a[e], h = 0; h < g.length; h++) d.push(b[e]);
    return d
  };
  n.J = function (a) {
    Id(this);
  ...
  n.toString = function () {
    ...
    if (!this.c) return '';
    for (var a = [
    ], b = this.c.I(), d = 0; d < b.length; d++) for (var e = b[d], g = encodeURIComponent(String(e)), e = this.J(e), h = 0; h < e.length; h++) {
      var k = g;
  ...
  function Od(a, b, d) {
    var e = new Date;
    e.setTime(e.getTime() + 86400000 * d);
  ...
  function Rd(a, b) {
    var d = Qd();
    if (d) if (a && b) d.ServicePort = a,
    d.ServiceHost = b;
     else try {
      delete d.ServicePort,
      delete d.ServiceHost
    } catch (e) {
  ...
  function Td(a, b, d) {
    ...
    e.send(h);
    if (200 != e.status) throw a = e.responseText,
    a = a.split(':', 1) [0],
  ...
  function Ud(a, b) {
    ...
    }, 'GET', void 0, 3000)  : Vd('127.0.0.1', a, d)
  }
  function Wd(a, b) {
    function d(b, d) {
  ...
  function Yd(a, b) {
    try {
      return 'true' === Td('https://' + b + ':' + a + '/DYMO/DLS/Printing/StatusConnected', {
      }, 'GET')
    } catch (d) {
      return !1
    }
  ...
  function Vd(a, b, d) {
    for (var e = [
    ], g = 41951; 41960 >= g; ++g) e.push(Zd(g, a));
    Ab(e).then(function () {
      setTimeout(d, 0)
    }).ka(function (e) {
      ea(e) ? (Rd(e, a), b())  : d()
    ...
    return new G(function (e, k) {
      ...
      jd(g, function (a) {
        ...
        if (rd(d)) {
          ...
          e(a)
        } else a = 'Failed to execute webservice command: ' + b + '. Error: ' + d.w(),
  ...
  Y.prototype.o = function () {
    for (var a = te(this), b = [
    ], d = 0; d < a.length; d++) b.push(T(U(a[d], 'Name')));
    return b
  };
  ...
  function we(a, b, d) {
    ...
    d = d.split('\n');
    for (l = 0; l < d.length; l++) y = d[l].replace('\r', ''),
    l < d.length - 1 && (y += '\n'),
    k = Jd,
    0 < b.length ? k = l < b.length ? b[l] : b[b.length - 1] : 0 < g.length && (k = l < g.length ? U(g[l], 'Font')  : U(g[g.length - 1], 'Font')),
    m = h,
  ...
  */
  ...
  function Ce(a) {
    ...
    for (var b = a.h, e = d = !1; a.l.length && !a.o; ) {
      ...
      if (h = a.i ? k : h) try {
        ...
        if (cb(b) || 'function' === typeof p.Promise && b instanceof p.Promise) e = !0,
        a.o = !0
      } catch (m) {
        b = m,
        a.i = !0,
  ...
  Pe.prototype.send = function (a, b, d, e) {
    ...
    b && (p._callbacks_[e] = Re(e, b), b = this.c, h = '_callbacks_.' + e, ca(h) || (h = [
      String(h)
    ]), Md(g.h, b, h));
    b = Ie(g.toString(), {
      timeout: this.L,
  ...
  var We = function () {
    ...
    for (var d = Array, e = new d(16), g = [
    ], h = {
    }, k = 0; 256 > k; k++) g[k] = (k + 256).toString(16).substr(1).toUpperCase(),
    h[g[k]] = k;
    b.f = function (a) {
      var b = new d(16),
      e = 0;
  ...
  function ff(a) {
    ...
    if ('ActiveXObject' in window) {
      ...
      var h;
      Ze('application/x-dymolabel') ? (O('chooseEnvironment > _createSafariPlugin'), h = $e())  : (O('chooseEnvironment > _createMacNsapiPlugin'), h = df());
  ...
  var P = function () {
    function a(g, h) {
      if (d) throw O('_createFramework > Error service discovery is in progress. '),
  ...
  function hf(a, b) {
    function d() {
      ...
      } else O('checkLegacyPlugins > non-IE'),
      g.isBrowserSupported = !0,
      Ze('application/x-dymolabel') ? (O('checkLegacyPlugins > \'application/x-dymolabel\''), g.isFrameworkInstalled = !0)  : g.errorDetails = 'DYMO Label Framework Plugin is not installed';
    ...
    if (Xd) return O('checkEnvironment > return existing instance of framework'),
    2 == Xd ? e()  : (g.isBrowserSupported = !0, g.isFrameworkInstalled = !0, g.isWebServicePresent = !1, a && a(g)),
    g;
    b ? Ud(e, d)  : Wd(e, d);
    return g
  }
  ...
  function qf(a) {
    ...
    var d = R(a);
    a = rf();
    for (var e, g, h, k, l, m = U(d, 'Printers'), r = m.getElementsByTagName('LabelWriterPrinter'), d = 0; d < r.length; d++) e = b(r[d], 'Name'),
    g = b(r[d], 'ModelName'),
    ...
    for (d = 0; d < r.length; d++) e = b(r[d], 'Name'),
    g = b(r[d], 'ModelName'),
    h = 'True' == b(r[d], 'IsConnected'),
    k = 'True' == b(r[d], 'IsLocal'),
    ...
    for (d = 0; d < m.length; d++) e = b(m[d], 'Name'),
    g = b(m[d], 'ModelName'),
  ...
  function yf(a, b, d, e) {
    function g(a, b) {
      var d = 4000 * a,
      e = '';
      d >= l.length ? a = - 1 : e = l.substr(d, 4000);
      (new Pe(k, 'c')).send({
        j: h,
        cid: a,
        pl: e
        ...
        k.c = Lc;
        0 == e ? - 1 != a ? g(++a, 0)  : k.log(Lc, 'Finished sending job payload for ' + h, void 0)  : - 5 == e ? 10 > b ? g(++d.lastAckChunkId, ++b)  : k.log(Kc, 'Unable to send print job data for "' + h + '": STATUS_INVALID_CHUNK_ID: Max retry count reached', void 0)  : 10 > b ? g(a, ++b)  : k.log(Kc, 'Unable to send print job data for "' + h + '": Max retry count reached', void 0)
      }, function () {
  ...
  w('dymo.label.framework.createLabelRenderParamsXml', function (a) {
    ...
    'undefined' != typeof a.pngUseDisplayResolution && S(e, 'PngUseDisplayResolution', a.pngUseDisplayResolution ? 'True' : 'False');
    return ie(d)
  });
  }) ();
