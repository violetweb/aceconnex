...
import { FileUploadModel } from '../matupload/fileuploadmodel';


@Component({
  selector: 'app-matupload',
  templateUrl: './matupload.component.html',
  styleUrls: ['./matupload.component.scss'],
  animations: [
    trigger('fadeInOut', [
...
export class MatuploadComponent implements OnInit {
 ...
 @Input() target = 'http://api.acetronic.com/upload';
